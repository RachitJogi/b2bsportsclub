...
var __TURBOPACK__imported__module__$5b$project$5d2f$public$2f$payment$2d$qr$2e$jpeg$2e$mjs__$7b$__IMAGE__$3d3e$__$225b$project$5d2f$public$2f$payment$2d$qr$2e$jpeg__$28$static__in__ecmascript$2c$__tag__client$2922$__$7d$__$5b$app$2d$ssr$5d$__$28$structured__image__object__with__data__url$2c$__ecmascript$29$__ = __turbopack_context__.i('[project]/public/payment-qr.jpeg.mjs { IMAGE => "[project]/public/payment-qr.jpeg (static in ecmascript, tag client)" } [app-ssr] (structured image object with data url, ecmascript)');
"use client";
;
;
;
...
async function compressImage(file, maxDim = 1600, quality = 0.8) {
    try {
        ...
        bitmap.close();
        const blob = await new Promise((resolve, reject)=>canvas.toBlob((b)=>b ? resolve(b) : reject(new Error("toBlob failed")), "image/jpeg", quality));
        const base = file.name.replace(/\.[^.]+$/, "") || "image";
        return fileToBase64(new File([
            blob
        ], `${base}.jpg`, {
            type: "image/jpeg"
        }));
...
function validate(values) {
    ...
    else if (values.playerPhoto.size > MAX_FILE_MB * 1024 * 1024) errors.playerPhoto = `Photo must be under ${MAX_FILE_MB} MB.`;
    if (!values.paymentScreenshot) errors.paymentScreenshot = "Upload the payment screenshot.";
    else if (values.paymentScreenshot.size > MAX_FILE_MB * 1024 * 1024) errors.paymentScreenshot = `Screenshot must be under ${MAX_FILE_MB} MB.`;
    return errors;
}
function RegistrationForm() {
    ...
    async function handleSubmit(event) {
        ...
        try {
            ...
            /* eslint-disable */ console.log(...oo_oo(`2390358244_141_6_141_70_4`, "Calling:", process.env.NEXT_PUBLIC_APPS_SCRIPT_URL));
            ...
            try {
                ...
                /* eslint-disable */ console.error(...oo_tx(`2390358244_155_8_155_79_11`, "Non-JSON response", response.status, text.slice(0, 300)));
            ...
            if (result.status === "success") {
                ...
                /* eslint-disable */ console.error(...oo_tx(`2390358244_163_8_163_29_11`, result));
                alert(result.message ?? "Failed to submit the form. Please try again.");
            }
        // ---- replaced section ends here ----
        } catch (error) {
            /* eslint-disable */ console.error(...oo_tx(`2390358244_168_6_168_52_11`, "Error submitting form:", error));
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$image$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                                src: __TURBOPACK__imported__module__$5b$project$5d2f$public$2f$payment$2d$qr$2e$jpeg$2e$mjs__$7b$__IMAGE__$3d3e$__$225b$project$5d2f$public$2f$payment$2d$qr$2e$jpeg__$28$static__in__ecmascript$2c$__tag__client$2922$__$7d$__$5b$app$2d$ssr$5d$__$28$structured__image__object__with__data__url$2c$__ecmascript$29$__["default"],
...
__turbopack_context__.v("/_next/static/media/payment-qr.2brqmrbarp_d_.jpeg" + (globalThis["NEXT_CLIENT_ASSET_SUFFIX"] || ''));}),
"[project]/public/payment-qr.jpeg.mjs { IMAGE => \"[project]/public/payment-qr.jpeg (static in ecmascript, tag client)\" } [app-ssr] (structured image object with data url, ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=_00w-vnl._.js.map